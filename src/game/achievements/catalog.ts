...
export const achievementCatalog = [
  ...
  { id: 'normal-d1-complete', category: 'progress', title: 'Fundamentos dominados', description: 'Completa los 80 expedientes de dificultad ★.' },
  { id: 'normal-d2-complete', category: 'progress', title: 'Paso firme', description: 'Completa los 80 expedientes de dificultad ★★.' },
  { id: 'normal-d3-complete', category: 'progress', title: 'Mente afilada', description: 'Completa los 80 expedientes de dificultad ★★★.' },
  { id: 'normal-d4-complete', category: 'progress', title: 'Investigador experto', description: 'Completa los 80 expedientes de dificultad ★★★★.' },
  { id: 'normal-d5-complete', category: 'progress', title: 'Maestro de la deducción', description: 'Completa los 80 expedientes de dificultad ★★★★★.' },
  { id: 'normal-all-400', category: 'progress', title: 'Archivo principal completo', description: 'Completa los 400 Casos Normales.' },
