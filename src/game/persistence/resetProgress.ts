...
const fixedProgressKeys = new Set([PROGRESS_KEY, NORMAL_PROGRESS_KEY, DAILY_SESSION_KEY, INFINITE_SESSION_KEY, PLAYER_STATS_KEY, INVESTIGATION_HISTORY_KEY, ACHIEVEMENT_PROGRESS_KEY])
