...
const smallCase = (clues: GameCase['characters'][number]['clues'][]): GameCase => ({ id: 'small', title: '', intro: '', difficulty: 1, rows: 2, columns: 2, zones: [{ id: 'z', name: 'Z', tone: 'z' }], board: [{ row: 1, column: 1, zoneId: 'z', occupiable: true }, { row: 1, column: 2, zoneId: 'z', occupiable: true }, { row: 2, column: 1, zoneId: 'z', occupiable: true }, { row: 2, column: 2, zoneId: 'z', occupiable: true }], characters: [{ id: 'a', name: 'A', avatar: '', isVictim: true, clues: clues[0] }, { id: 'b', name: 'B', avatar: '', isVictim: false, clues: clues[1] }], solution: [{ characterId: 'a', position: { row: 1, column: 1 } }, { characterId: 'b', position: { row: 2, column: 2 } }] })
describe('solver', () => {
