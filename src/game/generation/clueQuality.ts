...
export const isNegativeClue = (clue: Pick<Clue, 'type'>) => clue.type === 'notZone' || clue.type === 'notOnObject' || clue.type === 'notBesideObject' || clue.type === 'notBesideWall' || clue.type === 'notBesideEdgeFeature'
