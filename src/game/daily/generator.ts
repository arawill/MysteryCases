...
export function generateDailyCase(date: Date, difficulty: DifficultyRating = 1): GeneratedDailyCase {
  ...
  const profile = createDifficultyScenarioProfile({ id: getDailyPuzzleId(date, difficulty), title: 'Caso diario', intro: 'Un nuevo expediente espera hoy. Reconstruye dónde estaba cada persona y descubre quién se quedó a solas con la víctima.', difficulty, characters, seed: baseSeed })
