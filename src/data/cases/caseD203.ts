...
const characters: Character[] = [
  { id: 'sara', name: 'Sara', avatar: avatar(0), avatarImage: avatar(0), isVictim: false, clues: [{ id: 'd2c03-sara-row', type: 'row', row: 1, text: 'Estaba en la primera fila.' }, { id: 'd2c03-sara-adrian-offset', type: 'rowOffsetFromCharacter', targetCharacterId: 'adrian', rowOffset: -5, text: 'Estaba cinco filas al norte de Adrián.' }] },
  { id: 'bruno', name: 'Bruno', avatar: avatar(1), avatarImage: avatar(1), isVictim: false, clues: [{ id: 'd2c03-bruno-column', type: 'column', column: 2, text: 'Estaba en la segunda columna.' }, { id: 'd2c03-bruno-marcos-north', type: 'northOfCharacter', targetCharacterId: 'marcos', text: 'Estaba al norte de Marcos.' }] },
  { id: 'leire', name: 'Leire', avatar: avatar(2), avatarImage: avatar(2), isVictim: false, clues: [{ id: 'd2c03-leire-workshop', type: 'zone', zoneId: 'workshop', text: 'Estaba en el taller.' }] },
  { id: 'marcos', name: 'Marcos', avatar: avatar(3), avatarImage: avatar(3), isVictim: false, clues: [{ id: 'd2c03-marcos-column', type: 'column', column: 4, text: 'Estaba en la cuarta columna.' }, { id: 'd2c03-marcos-leire-south', type: 'southOfCharacter', targetCharacterId: 'leire', text: 'Estaba al sur de Leire.' }] },
  { id: 'noa', name: 'Noa', avatar: avatar(4), avatarImage: avatar(4), isVictim: false, clues: [{ id: 'd2c03-noa-column', type: 'column', column: 6, text: 'Estaba en la sexta columna.' }, { id: 'd2c03-noa-cryogenics', type: 'zone', zoneId: 'cryogenics', text: 'Estaba en criogenia.' }] },
  { id: 'adrian', name: 'Adrián', avatar: avatar(5), avatarImage: avatar(5), isVictim: false, clues: [{ id: 'd2c03-adrian-column', type: 'column', column: 1, text: 'Estaba en la primera columna.' }, { id: 'd2c03-adrian-vega-zone', type: 'sameZoneAsCharacter', targetCharacterId: 'vega', text: 'Estaba en la misma zona que Vega.' }] },
