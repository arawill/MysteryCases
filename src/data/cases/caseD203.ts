...
const characters: Character[] = [
  ...
  { id: 'bruno', name: 'Bruno', avatar: avatar(1), avatarImage: avatar(1), isVictim: false, clues: [{ id: 'd2c03-bruno-column', type: 'column', column: 2, text: 'Estaba en la segunda columna.' }, { id: 'd2c03-bruno-control', type: 'zone', zoneId: 'control', text: 'Estaba en control.' }] },
  { id: 'leire', name: 'Leire', avatar: avatar(2), avatarImage: avatar(2), isVictim: false, clues: [{ id: 'd2c03-leire-workshop', type: 'zone', zoneId: 'workshop', text: 'Estaba en el taller.' }, { id: 'd2c03-leire-corner', type: 'cornerOfZone', text: 'Estaba en una esquina del taller.' }] },
  { id: 'marcos', name: 'Marcos', avatar: avatar(3), avatarImage: avatar(3), isVictim: false, clues: [{ id: 'd2c03-marcos-row', type: 'row', row: 4, text: 'Estaba en la cuarta fila.' }, { id: 'd2c03-marcos-wall', type: 'besideWall', text: 'Estaba junto a la pared de la bodega.' }] },
  { id: 'noa', name: 'Noa', avatar: avatar(4), avatarImage: avatar(4), isVictim: false, clues: [{ id: 'd2c03-noa-cryogenics', type: 'zone', zoneId: 'cryogenics', text: 'Estaba en criogenia.' }, { id: 'd2c03-noa-container', type: 'besideObject', objectId: 'sealedContainer', text: 'Estaba junto a la caja metálica.' }] },
  { id: 'adrian', name: 'Adrián', avatar: avatar(5), avatarImage: avatar(5), isVictim: false, clues: [{ id: 'd2c03-adrian-column', type: 'column', column: 1, text: 'Estaba en la primera columna.' }, { id: 'd2c03-adrian-vega-north', type: 'northOfCharacter', targetCharacterId: 'vega', text: 'Estaba al norte de Vega.' }] },
