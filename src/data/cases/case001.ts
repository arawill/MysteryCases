...
const baseCharacters: Character[] = [
  ...
  { id: 'ines', name: 'Inés', avatar: '🦋', isVictim: false, clues: [{ id: 'ines-zone', type: 'zone', text: 'Estaba en el baño.', zoneId: 'bathroom' }, { id: 'ines-column', type: 'column', text: 'Ocupaba la quinta columna.', column: 5 }, { id: 'ines-row', type: 'row', text: 'Estaba en la quinta fila.', row: 5 }] },
