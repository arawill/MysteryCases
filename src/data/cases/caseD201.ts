...
const characters: Character[] = [
  { id: 'lina', name: 'Lina', avatar: '👤', avatarImage: avatar(0), isVictim: false, clues: [{ id: 'd2c01-lina-column', type: 'column', column: 6, text: 'Estaba en la sexta columna.' }, { id: 'd2c01-lina-north-nerea', type: 'northOfCharacter', targetCharacterId: 'nerea', text: 'Estaba al norte de Nerea.' }] },
  { id: 'oscar', name: 'Óscar', avatar: '👤', avatarImage: avatar(1), isVictim: false, clues: [{ id: 'd2c01-oscar-column', type: 'column', column: 2, text: 'Estaba en la segunda columna.' }, { id: 'd2c01-oscar-irene-offset', type: 'rowOffsetFromCharacter', targetCharacterId: 'irene', rowOffset: -4, text: 'Estaba cuatro filas al norte de Irene.' }] },
  { id: 'nerea', name: 'Nerea', avatar: '👤', avatarImage: avatar(2), isVictim: false, clues: [{ id: 'd2c01-nerea-column', type: 'column', column: 3, text: 'Estaba en la tercera columna.' }, { id: 'd2c01-nerea-wall', type: 'besideWall', text: 'Estaba junto a una pared.' }] },
  { id: 'tomas', name: 'Tomás', avatar: '👤', avatarImage: avatar(3), isVictim: false, clues: [{ id: 'd2c01-tomas-column', type: 'column', column: 5, text: 'Estaba en la quinta columna.' }, { id: 'd2c01-tomas-alma-offset', type: 'rowOffsetFromCharacter', targetCharacterId: 'alma', rowOffset: -3, text: 'Estaba tres filas al norte de Alma.' }] },
  { id: 'gael', name: 'Gael', avatar: '👤', avatarImage: avatar(4), isVictim: false, clues: [{ id: 'd2c01-gael-row', type: 'row', row: 5, text: 'Estaba en la quinta fila.' }, { id: 'd2c01-gael-tomas-zone', type: 'sameZoneAsCharacter', targetCharacterId: 'tomas', text: 'Estaba en la misma zona que Tomás.' }] },
  { id: 'irene', name: 'Irene', avatar: '👤', avatarImage: avatar(5), isVictim: false, clues: [{ id: 'd2c01-irene-column', type: 'column', column: 1, text: 'Estaba en la primera columna.' }, { id: 'd2c01-irene-alma-offset', type: 'rowOffsetFromCharacter', targetCharacterId: 'alma', rowOffset: -1, text: 'Estaba una fila al norte de Alma.' }] },
