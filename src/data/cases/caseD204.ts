...
const characters: Character[] = [
  { id: 'elena', name: 'Elena', avatar: avatar(0), avatarImage: avatar(0), isVictim: false, clues: [{ id: 'd2c04-elena-column', type: 'column', column: 4, text: 'Estaba en la cuarta columna.' }, { id: 'd2c04-elena-aitana-north', type: 'northOfCharacter', targetCharacterId: 'aitana', text: 'Estaba al norte de Aitana.' }] },
  { id: 'hugo', name: 'Hugo', avatar: avatar(1), avatarImage: avatar(1), isVictim: false, clues: [{ id: 'd2c04-hugo-console-column', type: 'sameColumnAsObject', objectId: 'irrigationConsole', zoneRelation: 'same', text: 'Estaba en la misma columna que la máquina de riego.' }] },
  { id: 'aitana', name: 'Aitana', avatar: avatar(2), avatarImage: avatar(2), isVictim: false, clues: [{ id: 'd2c04-aitana-reservoir', type: 'zone', zoneId: 'reservoir', text: 'Estaba en el depósito.' }, { id: 'd2c04-aitana-tank', type: 'besideObject', objectId: 'nutrientTank', text: 'Estaba junto al depósito cilíndrico.' }] },
  { id: 'ruben', name: 'Rubén', avatar: avatar(3), avatarImage: avatar(3), isVictim: false, clues: [{ id: 'd2c04-ruben-cultivation', type: 'zone', zoneId: 'cultivation', text: 'Estaba en cultivo.' }, { id: 'd2c04-ruben-console', type: 'relativeToObject', objectId: 'irrigationConsole', direction: 'southWest', zoneRelation: 'different', text: 'Estaba al suroeste de la máquina de riego.' }] },
  { id: 'joel', name: 'Joel', avatar: avatar(4), avatarImage: avatar(4), isVictim: false, clues: [{ id: 'd2c04-joel-tank-column', type: 'sameColumnAsObject', objectId: 'nutrientTank', zoneRelation: 'different', text: 'Estaba en la misma columna que el depósito cilíndrico.' }, { id: 'd2c04-joel-iris-north', type: 'northOfCharacter', targetCharacterId: 'iris', text: 'Estaba al norte de Iris.' }] },
  { id: 'marta', name: 'Marta', avatar: avatar(5), avatarImage: avatar(5), isVictim: false, clues: [{ id: 'd2c04-marta-storage', type: 'zone', zoneId: 'storage', text: 'Estaba en el almacén.' }, { id: 'd2c04-marta-cart', type: 'besideObject', objectId: 'harvestCart', text: 'Estaba junto al carro con plantas.' }] },
