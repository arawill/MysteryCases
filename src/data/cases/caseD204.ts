...
const characters: Character[] = [
  ...
  { id: 'hugo', name: 'Hugo', avatar: avatar(1), avatarImage: avatar(1), isVictim: false, clues: [{ id: 'd2c04-hugo-row', type: 'row', row: 2, text: 'Estaba en la segunda fila.' }, { id: 'd2c04-hugo-column', type: 'column', column: 2, text: 'Estaba en la segunda columna.' }] },
  { id: 'aitana', name: 'Aitana', avatar: avatar(2), avatarImage: avatar(2), isVictim: false, clues: [{ id: 'd2c04-aitana-row', type: 'row', row: 3, text: 'Estaba en la tercera fila.' }, { id: 'd2c04-aitana-tank', type: 'besideObject', objectId: 'nutrientTank', text: 'Estaba junto al depósito cilíndrico.' }] },
  { id: 'ruben', name: 'Rubén', avatar: avatar(3), avatarImage: avatar(3), isVictim: false, clues: [{ id: 'd2c04-ruben-row', type: 'row', row: 4, text: 'Estaba en la cuarta fila.' }, { id: 'd2c04-ruben-column', type: 'column', column: 1, text: 'Estaba en la primera columna.' }] },
  ...
  { id: 'marta', name: 'Marta', avatar: avatar(5), avatarImage: avatar(5), isVictim: false, clues: [{ id: 'd2c04-marta-row', type: 'row', row: 6, text: 'Estaba en la sexta fila.' }, { id: 'd2c04-marta-column', type: 'column', column: 3, text: 'Estaba en la tercera columna.' }] },
