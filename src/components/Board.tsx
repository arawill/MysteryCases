      ...
      <div className="board-with-rows" style={{ '--rows': rows } as React.CSSProperties}>
        ...
        <div className="board" style={{ '--columns': columns, '--rows': rows } as React.CSSProperties}>
          {Array.from({ length: rows * columns }, (_, index) => {
            ...
            const objectStyle = footprintBounds ? { '--object-footprint-columns': footprintBounds.columns, '--object-footprint-rows': footprintBounds.rows } as React.CSSProperties : undefined
