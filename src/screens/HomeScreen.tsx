  ...
  return <main className="home-screen">
    ...
    <section className="home-hero">
      <div className="home-hero-copy">
        <p className="eyebrow">ARCHIVO PRIVADO DE INVESTIGACIONES</p>
        <h1>Reconstruye la escena.<br /><span>Encuentra al culpable.</span></h1>
        <p>Un juego de deducción espacial para mentes observadoras.</p>
      </div>
    ...
    <AndroidDownloadCard />
    <nav className="secondary-nav" aria-label="Menú principal"><Link to="/stats">PERFIL</Link><Link to="/settings">OPCIONES</Link><Link to="/help">AYUDA</Link><Link to="/about">SOBRE MYSTERYCASES</Link></nav>
