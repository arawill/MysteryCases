...
export function HomeScreen() {
  ...
  return <main className="home-screen">
    ...
    <section><div className="section-heading"><div><p className="eyebrow">ELIGE TU INVESTIGACIÓN</p><h2>Casos a investigar</h2></div></div><NormalModeCard progress={progress} /><InfiniteModeCard session={loadInfiniteSession()} maxDifficulty={max} /></section>
